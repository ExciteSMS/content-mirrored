    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-20 bg-background">
        <div className="mx-auto max-w-7xl px-6 text-center">
          <span className="text-brand text-sm font-semibold uppercase tracking-widest">Partnerships</span>
          <h2 className="mt-3 text-3xl md:text-4xl font-bold">Our clients and strategic partners</h2>
      ...
      <footer className="bg-brand-deep text-white/85">
        <div className="mx-auto max-w-7xl px-6 py-10 border-b border-white/10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <form className="flex w-full md:w-auto gap-2" onSubmit={(e) => e.preventDefault()}>
            ...
            <button className="rounded-full bg-gradient-brand px-5 py-3 text-sm font-semibold">Subscribe</button>
          </form>
        </div>
